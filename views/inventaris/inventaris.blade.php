...
<table id="inventaris_table" class="table table-bordered table-hover">
  ...
  @foreach($datainven as $di)
      ...
      <td>{{$di->user_id}}</td>
			<td>
				<a href="{{route('inventaris.edit',['id'=>$di->id])}}" class="btn btn-primary btn-sm">Ubah</a>
...
<a href="" class="btn btn-primary" data-toggle="modal" data-target="#simpan">Tambah Data</a>
 <a href="{{route('inventaris.cetak')}}" class="btn btn-success" target="_blank">Print Laporan</a>
    ...
    <div class="modal-content">
	  ...
	  <div class="modal-body">
        ...
        <div class="form-grup">
            ...
            <input type="text" name="alias" class="form-control" readonly="" id="alias" value="{{Auth::user()->name}}">
