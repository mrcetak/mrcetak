...
Route::get('/home', 'HomeController@index')->name('home')->middleware('role:admin|operator|peminjam');
Route::get('/desain', 'AllController@tampildesain')->name('desain.tampil')->middleware('role:admin');

Route::get('/ruang', 'RuangController@tampilruang')->name('ruang.tampil')->middleware('role:admin');
...
Route::get('/ruang/cetak', 'RuangController@cetakruang')->name('ruang.cetak')->middleware('role:admin');

Route::get('/jenis', 'JenisController@tampiljenis')->name('jenis.tampil')->middleware('role:admin');
...
Route::get('/jenis/cetak', 'JenisController@cetakjenis')->name('jenis.cetak')->middleware('role:admin');

Route::get('/inventaris', 'InventarisController@tampilinventaris')->name('inventaris.tampil')->middleware('role:admin');
...
Route::get('/inventaris/cetak', 'InventarisController@cetakinventaris')->name('inventaris.cetak')->middleware('role:admin');

Route::get('/pegawai', 'PegawaiController@tampilpegawai')->name('pegawai.tampil')->middleware('role:admin|operator');
...
Route::get('/pegawai/cetak', 'PegawaiController@cetakpegawai')->name('pegawai.cetak')->middleware('role:admin');

Route::get('/peminjaman', 'PeminjamanController@tampilpeminjaman')->name('peminjaman.tampil')->middleware('role:admin|operator|peminjam');
...
Route::get('/peminjaman/cetak', 'PeminjamanController@cetakpeminjaman')->name('peminjaman.cetak')->middleware('role:admin|operator');

Route::get('/pengembalian', 'PengembalianController@tampilpengembalian')->name('pengembalian.tampil')->middleware('role:admin|operator');
...
Route::get('/pengembalian/cetak', 'PengembalianController@cetakpengembalian')->name('pengembalian.cetak')->middleware('role:admin');
